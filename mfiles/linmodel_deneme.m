...
Xlon=[1 2 3 4 6 8 12 14]; % States to keep (u,w,q,theta)
...
if vabflag
    Ylon = [1 2 3 4 6 8 12 14]; % outputs to keep (tas,alpha,q,theta)
    Ylat = [3 7 9 13]; % outputs to keep (beta,p,r,phi)
    londyn=modred(sys(Ylon,Ilon),setdiff(1:15,Xlon),'del');
    londyn.a = londyn.c*londyn.a*inv(londyn.c);
    londyn.b = londyn.c*londyn.b;
    londyn.c = eye(8);
    set(londyn,'Statename',Onames([1 2 3 4 6 8 12 14]))
